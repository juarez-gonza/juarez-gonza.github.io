...
users do not have to implement the =promise_​type= because a library may have
...
the =promise_​type= itself. To tackle this I will try to motivate on a case-by-case basis why each detail
