...
In this post I want to *empathise* with the design of C++20
coroutines. That is, this post is an attempt to convince myself of why
each part of the design of coroutines API is *needed*, and maybe think
about how it could have been changed or simplified while retaining
performance and expressive power.
...
The second pitfall is harder to avoid. The approach adopted in this
...
+ *"Hey! These coroutines are nothing like those in Lua, Go, nor
  ...
  approach. Some aspects may be familiar from other languages,
