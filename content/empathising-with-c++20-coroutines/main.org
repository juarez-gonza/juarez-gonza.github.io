...
difficult difficult part (the =promise_type=) because a library may have
already done it (for most users, that library may be [[https://www.boost.org/doc/libs/1_89_0/doc/html/boost_asio.html][asio]]).
