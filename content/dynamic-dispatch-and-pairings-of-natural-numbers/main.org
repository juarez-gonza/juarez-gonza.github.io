...
#+include: ./code/basic.cpp src c++ :lines "186-188"
...
- The [[http://szudzik.com/ElegantPairing.pdf][Szudzik pairing function]] is relatively recent, given that the
  last two entries were from the 1800s and the beginning of the
  1900s. It too can be visualized as a walk through a graph, but this
  time the walk follows the sides of increasingly larger squares.
...
#+include: ./code/basic.cpp src c++ :lines "14-41"
